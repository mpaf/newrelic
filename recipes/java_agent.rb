...
newrelic_agent_java 'Install' do
  ...
  distributed_tracing_enable NewRelic.to_boolean(node['newrelic']['application_monitoring']['distributed_tracing']['enable']) unless node['newrelic']['application_monitoring']['distributed_tracing']['enable'].nil?
